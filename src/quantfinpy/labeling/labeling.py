...
from quantfinpy.util.multiprocess import mp_pandas_obj


# Snippet 3.2, page 45, Triple Barrier Labeling Method
def apply_pt_sl_on_t1(close: pd.Series, events: pd.Series, 
                      pt_sl: np.array, molecule: np.array) -> pd.DataFrame:
    # pragma: no cover
    """
...
# Snippet 3.8 page 54
def drop_labels(events: pd.DataFrame, min_pct: float = .05) -> pd.DataFrame:
    """
